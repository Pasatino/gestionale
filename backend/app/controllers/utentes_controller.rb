class UtentesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to utentes_path, status: :see_other, notice: "Utente was successfully destroyed." }
  ...
  private
    ...
    def utente_params
      params.require(:utente).permit(:username, :password_digest, :nome, :cognome, :data_nascita)
    end
end
