...
class ProdottosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prodotto" do
    assert_difference("Prodotto.count") do
      post prodottos_url, params: { prodotto: { data_inserimento: @prodotto.data_inserimento, descrizione: @prodotto.descrizione, nome: @prodotto.nome, tipo_prodotto_id: @prodotto.tipo_prodotto_id } }
    end
  ...
  test "should update prodotto" do
    patch prodotto_url(@prodotto), params: { prodotto: { data_inserimento: @prodotto.data_inserimento, descrizione: @prodotto.descrizione, nome: @prodotto.nome, tipo_prodotto_id: @prodotto.tipo_prodotto_id } }
